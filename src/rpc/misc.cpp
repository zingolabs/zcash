    ...
    if (fHelp || params.size() != 1) {
        HelpSections help_sections =
            HelpSections(__func__)
                ...
                .set_description("Return information about the given Zcash address.")
                .set_arguments("1. \"zcashaddress\"     (string, required) The Zcash address to validate")
                .set_result(
                    "{\n"
                    ...
                    "}")
                .set_examples("\"1PSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"");
        throw runtime_error(
